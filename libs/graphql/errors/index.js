...
const ACTIVATE_STATUS_FORMAT = setNewError(ERROR_CODE.BAD_PARAMS.ACTIVATE_STATUS_FORMAT, 'ACTIVATE_STATUS_FORMAT');
const TYPE_FORMAT = setNewError(ERROR_CODE.BAD_PARAMS.TYPE_FORMAT, 'TYPE_FORMAT');
